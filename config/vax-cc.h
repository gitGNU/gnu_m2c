/* This file is used for tunning Modula-2 translator on vax CC (Berkley)
   compiler.
...
#define OPTIONS "string name name=def dir x output [p012] %%\
...
#define C_OUTPUT_EXISTS (!last_flag_place("-E") && !last_flag_place("-Em"))
...
#define LOAD_GUARD (!last_flag_place("-E") && !last_flag_place("-Em")\
...
#define TRANSLATE_FLAG_TO_LOAD(opt) (!strcmp(opt,"-3")\
 ...
 || !strcmp(opt,"-D")\
 || !strcmp(opt,"-D") || !strcmp(opt,"-E") || !strcmp(opt,"-Em")\
